 ...
 */
@Injectable()
export class IdentityServer4Interceptor implements HttpInterceptor {
  ...
  intercept(req: HttpRequest<any>, next: HttpHandler):
    ...
    {
      authHeader = authHeader.set('Authorization', `${this.authService.user.token_type} ${this.authService.user.access_token}`);
