...
@Component({
  selector: 'app-bisq',
  templateUrl: './bisq.component.html',
  styleUrls: ['./bisq.component.scss']
})
export class BisqComponent extends ListTable implements OnInit {
    public App = {
        "dataArray": [
            {
                "appId": "874539ee-e130-11e6-80c2-00155d454321",
                "gameId": "string",
                "appSecret": "string",
                "appName": "string",
                "appIconUrl": "string"
    ...
    //getDate() {
    //    this._loading = true;
    //    this.api.AdminGameInstance('874539ee-e130-11e6-80c2-00155d454321',100).subscribe(x => {
    //        this.gameinstance = x;
    //        this._loading = false;
    //    }).add(r => { this._loading = false; });
    //}
