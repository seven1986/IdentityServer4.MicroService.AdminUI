...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'openportal', loadChildren: './openportal/openportal.module#OpenPortalModule' },
        ]
    },
    // 全屏布局
    {
...
@NgModule({
  imports: [
    RouterModule.forRoot(routes, { useHash: environment.useHash, enableTracing: true }),
  ],
  exports: [RouterModule, OidcModule],
  providers: [
    AuthService,
    AuthGuardService
  ]
